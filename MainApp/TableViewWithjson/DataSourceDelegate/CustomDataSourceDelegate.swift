...
class CustomDataSourceDelegate: NSObject {
    ...
    fileprivate func setupTbl(){
        let nib = UINib(nibName: "CustomTc", bundle: nil)
        tblvw.register(nib, forCellReuseIdentifier: "CustomTc")
...
extension CustomDataSourceDelegate:UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblvw.dequeueReusableCell(withIdentifier: "CustomTc", for: indexPath)as! CustomTc
